...
bcfg driver add 05 DpcDxe.efi                           "NucRfsh:Dpc"
bcfg driver add 06 MnpDxe.efi                           "NucRfsh:Mnp"
bcfg driver add 07 ArpDxe.efi                           "NucRfsh:Arp"
bcfg driver add 08 Ip4Dxe.efi                           "NucRfsh:Ip4"
bcfg driver add 09 Udp4Dxe.efi                          "NucRfsh:Udp4"
bcfg driver add 10 TcpDxe.efi                           "NucRfsh:Tcp"
bcfg driver add 11 Dhcp4Dxe.efi                         "NucRfsh:Dhcp4"
bcfg driver add 12 DnsDxe.efi                           "NucRfsh:Dns"
bcfg driver add 13 HttpUtilitiesDxe.efi                 "NucRfsh:HttpUtil"
bcfg driver add 14 HttpDxe.efi                          "NucRfsh:Http"
bcfg driver add 15 RegularExpressionDxe.efi             "NucRfsh:Regex"

#  --- RedfishPkg core ---
bcfg driver add 16 RestJsonStructureDxe.efi             "NucRfsh:RestJson"
bcfg driver add 17 RedfishHostInterfaceDxe.efi          "NucRfsh:HostIface"
bcfg driver add 18 RedfishRestExDxe.efi                 "NucRfsh:RestEx"
bcfg driver add 19 RedfishCredentialDxe.efi             "NucRfsh:Credential"
bcfg driver add 20 RedfishDiscoverDxe.efi               "NucRfsh:Discover"
bcfg driver add 21 RedfishHttpDxe.efi                   "NucRfsh:RedfishHttp"
bcfg driver add 22 RedfishConfigHandlerDriver.efi       "NucRfsh:ConfigHandler"

#  --- platform config producer ---
bcfg driver add 23 RedfishPlatformConfigDxe.efi         "NucRfsh:PlatformConfig"

#  --- RedfishClientPkg feature layer (sync engine + domains) ---
bcfg driver add 24 RedfishFeatureCoreDxe.efi            "NucRfsh:FeatureCore"
bcfg driver add 25 RedfishETagDxe.efi                   "NucRfsh:ETag"
bcfg driver add 26 RedfishConfigLangMapDxe.efi          "NucRfsh:ConfigLangMap"
bcfg driver add 27 HiiToRedfishBootDxe.efi              "NucRfsh:HiiToBoot"
bcfg driver add 28 BiosDxe.efi                          "NucRfsh:BiosFeature"
bcfg driver add 29 BiosAttributeRegistryDxe.efi         "NucRfsh:BiosAttrReg"
bcfg driver add 30 BootOptionDxe.efi                    "NucRfsh:BootOption"
bcfg driver add 31 BootOptionCollectionDxe.efi          "NucRfsh:BootOptColl"
bcfg driver add 32 RedfishBios_V1_0_9_Dxe.efi           "NucRfsh:BiosConv"
bcfg driver add 33 RedfishAttributeRegistry_V1_3_6_Dxe.efi "NucRfsh:AttrRegConv"
bcfg driver add 34 RedfishBootOption_V1_0_4_Dxe.efi     "NucRfsh:BootOptConv"
